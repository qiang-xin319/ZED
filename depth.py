...
if __name__ == '__main__':
    # 读取图片
    iml = cv2.imread(r'F:\ZED2i-ranging\Binocular-ranging-main\L0.png', 1)  # 左图
    imr = cv2.imread(r'F:\ZED2i-ranging\Binocular-ranging-main\R0.png', 1)  # 右图
    ...
    disp, _ = stereoMatchSGBM(iml_, imr_, False)  # 传入的是经过预处理的未校正图像
